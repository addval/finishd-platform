...
See **dev/active/authentication-system/** in this repository for a real example:
- **authentication-system-plan.md** - Strategic plan for implementing JWT authentication with OTP
- **authentication-system-context.md** - Tracks what's completed, decisions made, what's next
- **authentication-system-tasks.md** - Checklist of all phases and tasks

This is the actual dev docs for building the authentication system!
...
- **Authentication System** (`dev/active/authentication-system/`)
  - JWT-based authentication with OTP email verification
  - Complete implementation plan with database, API, and frontend phases
  - Tracks progress across backend services, controllers, and middleware
...
4. **See it in action** - Browse dev/active/authentication-system/

**Questions?** See the main project documentation at `.claude/CLAUDE.md`
